...
(function ($) {
  ...
  if ($(window).width() < 768) {
    $(".header .language").after(
      '<div class="menu"><span class="span1"></span><span class="span2"></span><span class="span3"></span></div>'
    );

    $(".header .li-box>a").after('<p class="xl-menu"> <span>></span> </p>');
  }
  $(".menu").click(function () {
    $(this).toggleClass("on");
    ...
    if (glmin > 0 && glmax > 0) {
      ...
      if (filterarray) {
        ...
        window.location.href =
          window.location.href.split("?")[0] + "?" + buildQueryString(oldparam);
      }
    }
  });
})(jQuery);
